// Main model - Parametric Hook
// This demonstrates the user convention where main.js is the primary model
...
// Parametric configuration - this is the main export
...
export const modelMetadata = {
  name: "Parametric Hook",
  description: "A customizable wall hook - the main model for this project",
  author: "Manifold Studio",
  version: "1.0.0"
};

// Export the parametric config as default
