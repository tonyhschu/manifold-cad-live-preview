 ...
 */
export function isParametricConfig(obj) {
    return (obj !== null &&
        obj !== undefined &&
        typeof obj === 'object' &&
        'parameters' in obj &&
 ...
 */
export function extractDefaultParams(config) {
    const defaults = {};
 ...
 */
export function mergeParameters(defaults, userParams, options = {}) {
 ...
 */
export function parseParameterString(paramString) {
    const params = {};
 ...
 */
export function parseParameterValue(value) {
    if (value === 'true')
        return true;
    if (value === 'false')
        return false;
 ...
 */
export function getParameterInfo(config) {
